...
const pathways = [
  {
    ...
    description: 'Pick topics and work through 4-7 levels per topic. Each level has a unique accuracy target (100% at L1 down to 70% at L6+) to advance. Perfect for structured learning.',
